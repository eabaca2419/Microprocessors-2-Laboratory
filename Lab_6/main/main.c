...
<head>
    ...
    <title>Servo Motor Server</title>
</head>

<body>
    <div class="header">
        <h1>Servo Motor Server</h1>
    </div> 
        <input class="btn" id="btn0" type="button" value="Positive 90" onclick="sendRequest()"> 
        <input class="btn" id="btn1" type="button" value="Negative 90" onclick="sendRequest1()">
    </div>
    <style>
        * {
            margin: 0;
...
#define EXAMPLE_ESP_WIFI_SSID "ESP32_WIFI_MODULE"
